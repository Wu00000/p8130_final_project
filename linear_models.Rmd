...
```{r}
mod1 <- lm(crime_per1k ~ poverty + region + per_doc + per_bed + pop18, data = crime_df)
...
mod2 <- lm(crime_per1k ~ poverty + region + per_doc + per_bed + pop18 + per_doc * per_bed + poverty * per_doc + poverty * per_bed, data = crime_df)
summary(mod2)
